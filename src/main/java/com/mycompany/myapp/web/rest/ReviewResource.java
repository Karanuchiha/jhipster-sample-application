...
public class ReviewResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSampleApplicationReview";
    ...
    public ResponseEntity<Review> updateReview(@RequestBody Review review) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, review.getId()))
            .body(result);
    }
